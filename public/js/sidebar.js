...
const Sidebar = (() => {
  ...
  const NAV = [
    ...
    { id:'mensagens-padrao', href:'/mensagens-padrao.html', label:'Mensagens Padrão', roles:['SUPER_ADMIN','GESTOR'],
      ...
      <aside class="sidebar" role="navigation" aria-label="Menu principal">
        <div class="sidebar-logo">
          <div style="display:flex;align-items:center;gap:10px">
            <div style="width:32px;height:32px;border-radius:8px;background:var(--grad-brand);display:flex;align-items:center;justify-content:center;box-shadow:var(--shadow-glow-green);">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="#0D0D0D"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg>
            </div>
